      ...
      <CardContent className="p-4 sm:p-6 ">
        <div className="space-y-4">
          <div className="flex space-x-3 sm:space-x-4">
            <Link className="" href={`/profile/${post.author.username}`}>
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="break-words text-foreground text-sm mt-2  ">{post.content}</p>
            </div>
          ...
          <div className="flex items-center pt-2 space-x-4">
            ...
            >
              <MessageCircleIcon
                className={`size-5 ${showComments ? "fill-blue-500 text-blue-600" : ""}`}
              />
